...
export const DEFAULT_FORWARDERS = [
  { name: 'Google DNS Primary', address: '8.8.8.8', port: 53, protocol: 'udp' as const },
  { name: 'Google DNS Secondary', address: '8.8.4.4', port: 53, protocol: 'udp' as const },
  { name: 'Cloudflare DNS Primary', address: '1.1.1.1', port: 53, protocol: 'udp' as const },
  { name: 'Cloudflare DNS Secondary', address: '1.0.0.1', port: 53, protocol: 'udp' as const },
  { name: 'Quad9 DNS', address: '9.9.9.9', port: 53, protocol: 'udp' as const },
];
